...
<!-- Mirrored from bicycle-store-html.vercel.app/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 10:30:36 GMT -->
...
<!-- newsletter modal -->
    ...
    <main class="pt-12">
        ...
        <section class="inner-hero-section px-xl-20 px-lg-10 px-sm-7"
            ...
            <div class="container-fluid">
                <span class="text-animation-word text-h1 text-n100 mb-3">Services Details</span>
                <ul class="breadcrumb d-inline-flex align-items-center gap-lg-2 gap-1">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active"><a href="#">Services Details</a></li>
                </ul>
            </div>
        </section>
        <!-- hero section end -->
        ...
        <section class="service-details-section pt-120 pb-120 px-xl-20 px-lg-10 px-sm-7 overflow-lg-visible">
            <div class="container-fluid">
                <div class="row g-6">
                    <div class="col-lg-8">
                        <div class="service-details-banner reveal-scale mb-lg-15 mb-md-10 mb-8">
                            <img class="w-100" src="assets/images/service-details-banner.png"
                                alt="service details banner">
                        </div>
                        <div class="service-details-content mb-lg-10 mb-md-8 mb-6">
                            <h1 class="text-n100 mb-lg-8 mb-6">Bike Repairs and Maintenance</h1>
                            <div class="d-grid gap-lg-4 gap-2 mb-lg-6 mb-4">
                                <p class="text-base font-noto-sans text-n50 fw-normal">
                                    At CycleCity, we understand the importance of keeping your bike in peak
                                    condition. Our comprehensive repair and maintenance services are designed to ensure
                                    your
                                    ride is always smooth, safe, and enjoyable. Our general tune-ups include a thorough
                                    inspection, lubrication of moving parts, and precise adjustments to brakes, gears,
                                    and
                                    other critical components. This routine maintenance helps prevent issues before they
                                    arise and keeps your bike performing at its best. For brake and gear adjustments,
                                    our
                                    skilled technicians use the latest tools and techniques to ensure your bike stops
                                    and
                                    shifts smoothly and safely. If you experience a flat tire, our quick and reliable
                                    repair
                                    service will have you back on the road in no time. We also offer chain and
                                    drivetrain
                                    cleaning to remove dirt and grime, extending the life of these essential components
                                    and
                                    improving overall efficiency.
                                </p>
                                <p class="text-base font-noto-sans text-n50 fw-normal">
                                    In addition to these standard services, we specialize in custom repairs tailored to
                                    your
                                    bike's specific needs. Whether it's a complex mechanical issue or a unique problem,
                                    our
                                    experienced team is equipped to handle it. We take pride in our attention to detail
                                    and
                                    commitment to quality, ensuring every repair and maintenance service meets the
                                    highest
                                    standards. Trust CycleCity to keep your bike running smoothly and safely, so you can
                            ...
                            <div class="d-grid gap-lg-6 gap-4">
                                ...
                                <ul class="d-grid gap-lg-4 gap-2">
                                    <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                            class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                        Describe what's included, such as lubrication, adjustments, and inspections.
                                    </li>
                                    <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                            class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                        Detail the process and benefits of these adjustments.
                                    </li>
                                    <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                            class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                        Explain how you fix flat tires and check tire health
                                    </li>
                                    <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                            class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                        Describe the cleaning process and its impact on bike performance.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="service-details-content mb-lg-10 mb-md-8 mb-6">
                            <h2 class="text-n100 mb-lg-6 mb-4">Custom Bike Builds</h2>
                            <p class="text-base font-noto-sans text-n50 fw-normal mb-4">
                                Experience the ultimate in personalization with our Custom Bike Build service. At
                                CycleCity, we work with you to design and build a bike tailored to your unique
                                preferences and riding style. From selecting top-quality components to ensuring a
                                perfect fit, our expert team ensures your custom bike meets all your expectations.
                            </p>

                            <div class="d-sm-flex d-grid align-items-center gap-xl-10 gap-lg-8 gap-4">
                                <div>
                                    <h4 class="text-n100 mb-lg-6 mb-4">Process:</h4>
                                    <ul class="d-grid gap-lg-4 gap-2">
                                        <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                                class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                            Consultation: Describe the initial consultation to understand the customer's
                                            needs.
                                        </li>
                                        <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                                class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                            Design and Selection: Explain how you help select components and design the
                                            bike.
                                        </li>
                                        <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                                class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                            Build: Outline the building process and timeline.
                                        </li>
                                        <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                                class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                            Final Fitting: Detail the final adjustments to ensure a perfect fit.
                                        </li>
                                        <li class="d-flex text-sm text-n50 font-noto-sans fw-normal"> <span
                                                class="d-flex text-xl"><i class="ph-fill ph-dot-outline"></i></span>
                                            Final Fitting: Detail the final adjustments to ensure a perfect fit.
                                ...
                                <div class="reveal-scale">
                                    <img class="w-100" src="assets/images/custom-bike-build.png"
                                        alt="custom bike build">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-section">
                            <h3 class="text-n100 mb-lg-6 mb-4">FAQS</h3>
                            <div class="accordion-area d-grid gap-lg-5 gap-3">
                                <div class="accordion-item p-lg-6 p-4 border border-n100-1 show">
                                    <div class="accordion-header d-between gap-2">
                                        <button class="accordion-button text-n100">
                                            Q: How long does it take to build a custom bike?
                                        </button>
                                    ...
                                    <div class="accordion-content">
                                        <div class="pt-lg-4 pt-2">
                                            <p class="text-n50 text-base">
                                                A: The custom bike build process can take anywhere from a few weeks
                                                to a couple of months, depending on the complexity and availability
                                                of components.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item p-lg-6 p-4 border border-n100-1">
                                    <div class="accordion-header d-between gap-2">
                                        <button class="accordion-button text-n100">
                                            Q: How do I sign up for a cycling class or workshop?
                                        </button>
                                        <span class="accordion-icon d-center"></span>
                                    </div>
                                    <div class="accordion-content">
                                ...
                                <div class="accordion-item p-lg-6 p-4 border border-n100-1">
                                    <div class="accordion-header d-between gap-2">
                                        <button class="accordion-button text-n100">
                                            Q: Can I choose specific components for my custom bike?
                                        </button>
                                        <span class="accordion-icon d-center"></span>
                                    </div>
                                    <div class="accordion-content">
                                ...
                                <div class="accordion-item p-lg-6 p-4 border border-n100-1">
                                    <div class="accordion-header d-between gap-2">
                                        <button class="accordion-button text-n100">
                                            Q: What should I bring to a bike fitting session?
                                        </button>
                                        <span class="accordion-icon d-center"></span>
                                    </div>
                                    <div class="accordion-content">
                    ...
                    <div class="col-lg-4">
                        <div class="position-sticky top-15">
                            <div
                                class="list-card p-4xl-10 p-3xl-8 p-sm-6 p-4 border border-n100-1 mb-lg-10 mb-md-8 mb-6">
                                <h4 class="text-n100 mb-lg-6 mb-4">Services List</h4>
                                <ul class="d-grid gap-lg-5 gap-3">
                                    <li>
                                        <a href="#"
                                            class="d-between gap-4 py-lg-4 py-2 px-xl-8 px-md-6 px-4 bg-n20 text-n100 hover-text-n0 box-style box-secondary2 ">
                                            <span class="text-base">Bike Repairs and Maintenance</span>
                                            <span class="text-2xl d-flex"><i class="ph ph-caret-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="d-between gap-4 py-lg-4 py-2 px-xl-8 px-md-6 px-4 bg-n20 text-n100 hover-text-n0 box-style box-secondary2 ">
                                            <span class="text-base">Custom Bike Builds</span>
                                            <span class="text-2xl d-flex"><i class="ph ph-caret-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="d-between gap-4 py-lg-4 py-2 px-xl-8 px-md-6 px-4 bg-n20 text-n100 hover-text-n0 box-style box-secondary2 ">
                                            <span class="text-base">Bike Fitting Services</span>
                                            <span class="text-2xl d-flex"><i class="ph ph-caret-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="d-between gap-4 py-lg-4 py-2 px-xl-8 px-md-6 px-4 bg-n20 text-n100 hover-text-n0 box-style box-secondary2 ">
                                            <span class="text-base">Bike Rentals</span>
                                            <span class="text-2xl d-flex"><i class="ph ph-caret-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="d-between gap-4 py-lg-4 py-2 px-xl-8 px-md-6 px-4 bg-n20 text-n100 hover-text-n0 box-style box-secondary2 ">
                                            <span class="text-base">Cycling Classes and Workshops</span>
                                            <span class="text-2xl d-flex"><i class="ph ph-caret-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="d-between gap-4 py-lg-4 py-2 px-xl-8 px-md-6 px-4 bg-n20 text-n100 hover-text-n0 box-style box-secondary2 ">
                                            <span class="text-base">Group Rides and Events</span>
                                            <span class="text-2xl d-flex"><i class="ph ph-caret-right"></i></span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="mini-cta position-relative">
                                <div
                                    class="mini-cta-content position-absolute bottom-0 start-0 p-xl-10 p-lg-8 p-6 w-100">
                                    <div class="p-xl-10 p-lg-8 p-6 bg-primary">
                                        <div class="d-center gap-2 mb-lg-4 mb-2">
                                            <span class="text-n100 text-h4"><i class="ph-fill ph-phone-call"></i></span>
                                            <span class="text-n100 text-h4">Call 24 hr/ 7 days</span>
                                        </div>
                                        <span
                                            class="d-block text-center text-n0 text-base bg-n100 py-lg-4 py-2">16957</span>
                                    </div>

                                </div>
                                <div class="mini-cta-banner">
                                    <img class="w-100" src="assets/images/mini-cta.png" alt="bg">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from bicycle-store-html.vercel.app/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 10:30:38 GMT -->
</html>