            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="form-section animate-in" id="reviewSection" style="display: none;">
                        ...
                        <div id="orderReview">
                            <!-- Order review content will be hear by JavaScript -->
                        </div>
                    </div>
                    ...
                    <div class="order-summary">
                            ...
                            while ($item = mysqli_fetch_assoc($carts)): ?>
                                ...
                                <div class="product-item">
                                    <div class="product-image position-relative">
                                        <img src="./assets/uploads/product/<?php echo  $firstImage ?>" alt="Giant Defy Advanced" class="w-100 h-80 ">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-primary mb-0"><b>₹<?= htmlspecialchars($item['product_price']) ?></b></p>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        ...
                        <div class="coupon-section mb-4">
                            ...
                            <div class="available-coupons mt-4">
                                ...
                                <div class="coupon-scroll d-flex gap-3 overflow-auto px-2 py-3">

                                    <!-- Coupon -->
                                    <div class="coupon-box  rounded p-3 flex-shrink-0 border " style="min-width: 220px;border:1px solid ;">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="badge bg-light text-dark border">SAVE20</span>
                                            <button class="btn btn-sm btn-link text-decoration-none text-primary copy-code" data-code="SAVE20">Apply</button>
                                        </div>
                                        <small class="text-muted">Get 20% OFF on orders above ₹500</small>
                                    </div>

                                    <!-- Coupon -->
                                    <div class="coupon-box  rounded p-3 flex-shrink-0 border " style="min-width: 220px;border:1px solid ;">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="badge bg-light text-dark border">FLAT100</span>
                                            <button class="btn btn-sm btn-link text-decoration-none text-success copy-code" data-code="FLAT100">Apply</button>
                                        </div>
                                        <small class="text-muted">Flat ₹100 OFF on orders above ₹1000</small>
                                    </div>

                                    <!-- Coupon -->
                                    <div class="coupon-box  rounded p-3 flex-shrink-0 border " style="min-width: 220px;border:1px solid ;">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="badge bg-light text-dark border">NEWUSER50</span>
                                            <button class="btn btn-sm btn-link text-decoration-none text-warning copy-code" data-code="NEWUSER50">Apply</button>
                                        </div>
                                        <small class="text-muted">50% OFF for first-time users</small>
                                    </div>
                        ...
                        <script>
                            // Auto-fill coupon input when "Apply" is clicked
                        ...
                        <div class="order-totals">
                            <div class="d-flex justify-content-between mb-2">
                                <span>Subtotal:</span>
                                <span><b>₹<?= htmlspecialchars($subtotal) ?></b></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Shipping:</span>
                        ...
                        <div class="estimated-delivery mt-4 p-3 bg-light rounded">
                            ...
                            <p id="delivery-text" class="mb-0 text-muted"></p>
                        </div>
                        ...
                        <script>
                            ...
                            // End: today + 15 days (optional 3-day window)
                            const endDate = new Date(today);
                            endDate.setDate(today.getDate() + 15);

                            document.getElementById("delivery-text").innerHTML =
                                `Your order will be delivered between <strong>${formatDate(startDate)} - ${formatDate(endDate)}</strong>`;
                        </script>
    ...
    <script>
        class EnhancedCheckout {
            ...
            async fetchLocationData(pincode) {
                ...
                try {
                    ...
                    if (data.places && data.places.length > 0) {
                        ...
                        $('#pincode').removeClass('input-success');
                    }
                } catch (error) {
                    this.showError('Unable to fetch location data. Please check the PIN code.');
                    $('#pincode').addClass('input-error');
                    $('#pincode').removeClass('input-success');
            ...
            populateLocationData(data) {
                // Zippopotam.us returns data in a different format
                const primaryPlace = data.places[0];

                // Set city and state
                $('#city').val(primaryPlace['place name']);
                $('#state').val(primaryPlace['state']);

                const $areaSelect = $('#area');
                $areaSelect.html('<option value="">Select Area</option>');

                // Add all available places/areas for this PIN code
